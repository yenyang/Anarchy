    ...
    public class LocaleEN : IDictionarySource
    {
        ...
        public LocaleEN(AnarchyModSettings setting)
        {
            ...
            m_Localization = new Dictionary<string, string>()
            {
                ...
                { m_Setting.GetOptionDescLocaleID(nameof(AnarchyModSettings.ReplaceUpgradesBehavior)), "With this option enabled and while replacing networks, upgrades will by default be removed/added per tool options toggles. If disabled, they will be preserved is possible by default. You can change the behavior in-game by selecting the individual replace toggles for each row of options." },
