...
const showUpgrade$ = bindValue<SideUpgrades>(mod.id, "LeftShowUpgrade");

export const LeftButtonComponent = (props: { src : string,  localeId : string | JSX.Element, upgrade: SideUpgrades }) => {
