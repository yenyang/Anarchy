...
* Not much testing is done on the effects of this mod on maps created using the editor.
...
## Support
Please contact me on **Cities: Skylines Modding Discord**.
...
* Klyte45, Algernon, T.D.W., Nullpinter - Help with UI, Cooperative Development and Code Sharing
...
* Localization: Nyoko, Citadino, Dome, elGendo87 and Eryalito (Spanish), Hendrix, Fuchs23, FearMyFeedEU, Infinityuranium and redlabracer (German), RilkeXS, CBEdwin, zlhww and GuaGua_ua (Chinese Simplified), Luis Fernando de Paula, dvzz, and felipecollucci (Brazilian Portuguese), Maxi, raistlin46 and mariostabile1 (Italian), karmel68 and Lisek (Polish), Tanat, TwotoolusFLY_LSh.st, Hinanchovo, and acelion19 (Korean), OWSEEX, Katsumoto, TraceXR, krugl1y, quoxsii and Bob.Smith17 (Russian) and Morgan Toverux, spooky_off, Quoifleur, Karg, CEO of Tabarnak and Edou24 (French), Seraphina, main1108, and mossy (Japanese), allegretic and _Windy_ (Chinese Traditional), ti4go and ruidias (European Portuguese), Jesyx, scoobysub, WISSAH, kwalnoot, and scoobysub (Dutch), GamingNerdLeith (Arabic), Emppu45 (Finnish).
